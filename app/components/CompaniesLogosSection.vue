<template>
  ...
  >
    ...
    <div class="mx-auto max-w-6xl px-6 mb-6">
      <p class="section-label justify-center text-center">Trusted by</p>
    </div>
    ...
    <div class="w-full overflow-hidden">
      ...
      <div
        class="flex shrink-0 gap-x-16 will-change-transform"
        :style="{
      ...
      >
        <div
          ...
          class="flex shrink-0 items-center gap-x-16"
        >
          <a
            ...
            class="flex h-14 w-32 shrink-0 items-center justify-center transition-all duration-300 opacity-40 hover:opacity-90 grayscale hover:grayscale-0"
          ...
          >
            <img
              ...
              :src="logo.src"
              :alt="logo.name"
              class="max-h-10 w-auto max-w-[110px] object-contain object-center"
              @error="markLogoFailed(logo.src)"
            />
            <span
              v-else
              class="text-center text-xs font-medium uppercase tracking-wider text-[var(--c-text-muted)]"
            >
              {{ logo.name }}
            </span>
          </a>
